...
export function buildQueryToolSelectionInstructions(): string {
  return [
    ...
    'no tool could possibly answer it. For a general "where did my money go",',
    '"where did/does my money/it go/went", "breakdown", or "what did I spend',
    'on" question that does NOT name one specific category, prefer',
    '"spending_by_category" (the whole picture) over "total_spent" (a single',
